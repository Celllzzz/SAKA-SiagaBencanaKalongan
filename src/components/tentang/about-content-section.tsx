...
export function AboutContentSection() {
  return (
    <section className="w-full bg-[#FAE3C7] text-[#3B2215] px-[20px] md:px-[32px] xl:px-[50px] py-[50px] overflow-hidden" data-theme="light" data-bg="#FAE3C7">
      <div className="w-full max-w-[1440px] mx-auto flex flex-col relative">
        ...
        <div className="flex flex-col xl:flex-row justify-between items-stretch w-full gap-[30px] xl:gap-0">
          ...
          <div className="flex flex-col w-full xl:w-[50%] shrink-0">
            ...
            {/* KKN Logo */}
            <div className="relative w-[180px] xl:w-[240px] h-[76px] xl:h-[102px] mt-[40px] xl:mt-auto self-center">
              <Image
